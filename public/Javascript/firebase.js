    ...
    function createRow(key, data) {
      ...
      deleteBtn.addEventListener('click', function() {
        ...
        if (window.confirmAction) {
          window.confirmAction('Delete this patient record? This action cannot be undone.', doRemove);
        } else {
          if (confirm('Delete this patient record? This action cannot be undone.')) doRemove();
        }
      });
